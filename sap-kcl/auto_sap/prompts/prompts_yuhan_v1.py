...
def system_message(protocol_text: str) -> str:
    ...
    return (
        ...
        "- The Yuhan SAP template contains standard required content (in black text) that indicates "
        "TOPICS that must be covered — not exact wording to copy. Adapt the content to match "
        "the specific protocol while ensuring the required topics are addressed.\n"
